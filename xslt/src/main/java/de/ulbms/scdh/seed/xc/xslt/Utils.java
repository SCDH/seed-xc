...
public class Utils {
	 ...
	 */
	public static InputStream fromZip(ZipFile zipFile, String path)
		...
		try {
			...
			throw new ConfigurationException("file not found in zip package: " +
											 path);
		} catch (Exception e) {
			LOG.error("cannot extract file {} from zip package: {}", path,
					  e.getMessage());
