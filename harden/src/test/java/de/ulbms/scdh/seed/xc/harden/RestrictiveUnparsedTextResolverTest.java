...
public class RestrictiveUnparsedTextResolverTest {
    ...
    private static final File HELLO_XML = Paths.get("src", "test", "resources", "samples", "hello.xml").toFile();

    private static final File HELLO_XML_VIA_DOTS = Paths.get("src", "test", "resources", "xsl", "..", "samples", "hello.xml").toFile();
